...
public class MyLoggerAdvisor implements CallAroundAdvisor, StreamAroundAdvisor {
    ...
    private void observeAfter(AdvisedResponse advisedResqponse) {
        //处理执行完成后的业务逻辑
        if (advisedResqponse.response()!= null){
            log.info("AI Response-------- : {}", advisedResqponse.response().getResult().getOutput().getText());
        }
    }
